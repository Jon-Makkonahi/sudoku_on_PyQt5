...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        action = myMenuFile.addAction(
            QtGui.QIcon(r"images/new.png"),
            "&Новый",
        ...
        action = myMenuFile.addAction(
            QtGui.QIcon(r"images/print.png"),
            "&Печать...",
            self.onPrint,
        ...
        action = myMenuFile.addAction(
            QtGui.QIcon(r"images/preview.png"),
        ...
        action = myMenuEdit.addAction(
            QtGui.QIcon(r"images/copy.png"),
            "К&опировать",
            self.onCopyData,
        ...
        action = myMenuEdit.addAction(
            QtGui.QIcon(r"images/paste.png"),
            "&Вставить",
            self.onPasteData,
        ...
        action = myMenuEdit.addAction(
            QtGui.QIcon(r"images/unlock.png"),
            "Р&азблокировать все",
        ...
        action.setStatusTip("Получение сведений о библиотеке PyQt")
    ...
    """
    Вставляет из буфера обмена данные, представленные в полном или
    компактном формате, предварительно проверив эти данные на корректность
    """
    ...
    """
    вставляет из буфера обмена данные, представленные в формате
    для Excel, предварительно проверив эти данные на корректность
    """
    ...
    """Загружает сохраненную в файле головоломку"""
    def onOpenFile(self):
    ...
    def onPrint(self):
        ...
        pd.setOptions(
            QtPrintSupport.QAbstractPrintDialog.PrintToFile |
